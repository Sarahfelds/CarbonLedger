...
class AlgorandService {
  final _doc = FirebaseFirestore.instance.collection('liveData').doc('algorand');
  ...
  Future<Map<String, double>?> getBlockchainData() async {
    try {
      ...
      print('❌ Error fetching Algorand data: $e');
      return null;
    }
  }
  ...
  Future<double> _fetchPriceUSD() async {
    try {
      ...
      return (body['algorand']['usd'] ?? 0).toDouble();
    } catch (e) {
      print('❌ Error fetching Algorand price: $e');
      return 0;
    }
  }
}
